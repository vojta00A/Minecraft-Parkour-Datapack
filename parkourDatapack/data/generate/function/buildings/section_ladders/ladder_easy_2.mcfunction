...
execute at @e[type=marker,tag=builder] run setblock ~1 ~ ~1 ladder[facing=south]
execute at @e[type=marker,tag=builder] run setblock ~1 ~2 ~ stone
execute at @e[type=marker,tag=builder] run setblock ~3 ~ ~ stone
execute at @e[type=marker,tag=builder] run setblock ~3 ~ ~1 ladder[facing=south]
execute at @e[type=marker,tag=builder] run setblock ~3 ~2 ~ stone
...
tag @e[type=marker,tag=builder] add tag_ladder_easy_2

# 3. Posun prevX o šířku této stavby
scoreboard players add @p prevX 3